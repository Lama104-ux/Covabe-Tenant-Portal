        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_News_Properties_PropertyId",
                        column: x => x.PropertyId,
                        principalTable: "Properties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MoveInDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    ...
                    NoticePeriodMonths = table.Column<int>(type: "int", nullable: false),
                    AnnualRentAdjustmentPercent = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                    IsIndexLinked = table.Column<bool>(type: "bit", nullable: false),
                    IncludesHeating = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CovabeWorkOrderId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    LastKnownStatus = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoanedDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoanedItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LoanedItems_Contracts_ContractId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoanedItems_ContractId",
                table: "LoanedItems",
                column: "ContractId");
